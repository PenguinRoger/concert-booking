                ...
                @foreach($bookings as $booking)
                    <div class="concert-card">
                        <div class="concert-image">
                            <img src="{{ asset('images/' . $booking->concert->image) }}" alt="{{ $booking->concert->name }}">
                        </div>
                        ...
                        <a href="{{ route('printTickets', ['bookingId' => $booking->id]) }}" class="btn btn-primary">Print Ticket</a>
