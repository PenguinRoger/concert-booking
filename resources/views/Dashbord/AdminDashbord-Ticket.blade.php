                    ...
                    <div class="col-md-3">
                        <div class="card mb-4 ">
                            ...
                            <div class="card-body">
                                ...
                                <a  data-toggle="modal" data-target="#manageTicketModal{{ $concert->id }}" class="btn btn-primary">Manage Tickets</a>
                            </div>
                        </div>
                    </div>
                            <div class="modal fade" id="manageTicketModal{{ $concert->id }}" tabindex="-1" aria-labelledby="manageTicketModalLabel{{ $concert->id }}" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="manageTicketModalLabel{{ $concert->id }}">Tickets for {{ $concert->name }}</h5>
                                        ...
                                        <div class="modal-body">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="modal fade" id="edit-ticket{{ $ticket->id }}" tabindex="-1" aria-labelledby="edit-ticketLabel{{ $ticket->id }}" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="edit-ticketLabel{{ $ticket->id }}">แก้ไขตั๋วสำหรับ {{ $concert->name }}</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <form action="/update-ticket/{id}" method="post">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control" name="type" value="{{ $ticket->type }}" required>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                ...
                                                                <div class="modal fade" id="delete-ticket{{ $ticket->id }}" tabindex="-1" aria-labelledby="delete-ticketLabel{{ $ticket->id }}" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="delete-ticketLabel{{ $ticket->id }}">ยืนยันการลบตั๋ว</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                คุณแน่ใจที่จะลบตั๋วประเภท {{ $ticket->type }} ของคอนเสิร์ต {{ $concert->name }} ใช่หรือไม่?
                                                                            </div>
                                            ...
                                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addticket{{ $concert->id }}"> เพิ่มตั๋ว</button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="addticket{{ $concert->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="addticket{{ $concert->id }}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="addticket">เพิ่มตั๋วสำหรับ {{ $concert->name }}</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    </div>
